...
<span onClick={this.createSortHandler(column.id)}>
    {column.label}</span>
                                <TableSortLabel
...
const styles = theme => ({
    ...
    lightGreyText: {
        color: styleGuide.lightGreyText,
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <div className={classes.tableCell}>
                                                            <Checkbox checked={isSelected}
                                                                      ...
                                                                      className={'checkboxTheme' + ' ' + classes.tableCheckbox}
                                                    ...
                                                    <TableCell component="th" scope="row" padding="none">
                                                        <div className={classes.tableCell}>
                                                            ...
                                                            <span className={'Darker BodyCopy'}> {n.name}</span>
                                                        </div>
                                                    ...
                                                    <TableCell numeric className={classes.tableHead}>
                                                        <div className={classes.tableCell}>
                                                            <span
                                                                className={' icon-barcode-16' + ' ' + classes.tableIcon}/>
                                                    ...
                                                    <TableCell numeric>
                                                        <div className={classes.tableControl + ' ' + classes.tableCell}>
                                                            <span className={' icon-subtract-16 formIcon'}/>


                                                            <span>       {n.carbs}</span>

                                                            <span className={' icon-add-16 formIcon'}/>
                                                    ...
                                                    <TableCell numeric onClick={e => this.goDetail(e)}>
                                                        <div className={classes.tableCell}>
                                                            <Link to={'/products/p'}
                                                                  className={' removeTxtDeco icon-more-16'}/>
                                                        </div>
