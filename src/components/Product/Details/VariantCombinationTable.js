...
import GreyButton from '../../Widget/GreyButton'
...
const styles = theme => ({
    ...
    tableHeader:styleGuide.tableHeader,
    tableCellHead:{
    ...
    return (
            <Table className={classes.table}>
                <TableHead>
                    <TableRow >
                        <CustomTableCell
                            className={classes.tableCellHead +' ' + classes.tableHeader}
                        >color | size</CustomTableCell>
                        <CustomTableCell numeric className={classes.tableHeader}>SKU</CustomTableCell>
                        <CustomTableCell numeric className={classes.tableHeader}>price</CustomTableCell>
                        <CustomTableCell numeric className={classes.tableHeader}> </CustomTableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {data.map(n => {
