...
import {regBorder} from '../../../constants/styleGuide'
...
const styles = theme => ({
    ...
    divImg:styleGuide.imgWraper,
    img: styleGuide.imgWraped,
    title: {
...
class BlogsCol extends React.Component {
    state = {
        anchor: 'left',
    };
                    ...
                    <Grid container alignItems={'center'}>
                        ...
                        <Grid item>
                            <div className={classes.title}>
                                10 Products that will make you life easier
                            </div>
                ...
                <Grid item sm={4}>
                    <Grid container alignItems={'center'} justify={'flex-end'}>
                        ...
                        <Grid item className={classes.more}>
                            <Link to={'/feeds/p'} className={' icon-more-16'}/>
                        </Grid>
                    </Grid>
                </Grid>
...
export default withStyles(styles)(BlogsCol);