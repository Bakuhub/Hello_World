    ...
    render() {
        ...
        return (
            <Grid container alignItems={'stretch'} className={classes.root}>
                ...
                <Grid item sm={3}>
                    <Grid container>
                        <Grid item sm={12} container justify={'flex-end'} className={classes.tools}>
                            <Link

                                to={'/feeds/section/edit'} className={' icon-more-16'+' '+classes.iconMore}/>
                        </Grid>
                        <Grid item sm={12} container justify={'flex-end'} className={classes.tools}>
                            ...
                            <GreyButton
                                link={'/feeds/new'}
                                icon={'icon-add-16'+' '+classes.testing}
                                value={'Add Media'}
                            />

                        </Grid>
                        <Grid item sm={12} container justify={'flex-end'} alignItems={'center'}
                              className={classes.media +' '+ classes.tools}>
